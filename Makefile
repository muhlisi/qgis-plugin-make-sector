...
SOURCES = \
	__init__.py \
	make_sector.py make_sector_dialog.py

PLUGINNAME = make_sector

PY_FILES = \
	__init__.py \
	make_sector.py make_sector_dialog.py

UI_FILES = make_sector_dialog_base.ui
...
QGISDIR=C:\Users\Sibro\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
